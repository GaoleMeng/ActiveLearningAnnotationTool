...
# 			#self.cell = tf.contrib.rnn.AttentionCellWrapper(self.cell, 1, state_is_tuple=True)
...
# 			# cell = cell_fn(args.rnn_size);
# 			# bicells.append(cell);
# 			# self.bi_cell = rnn.MultiRNNCell(bicells, state_is_tuple=True)
...
# 		#outputs, last_state = tf.nn.dynamic_rnn(self.model.cell, inputs, initial_state=self.initial_state ,scope = None);
